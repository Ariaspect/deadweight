...
export function applyUpgrades(base: Tuning, owned: string[], defs: UpgradeDef[]): Tuning {
  const t: Tuning = { ...base, gaitSpeed: [...base.gaitSpeed], starBuckets: [...base.starBuckets], slotPos: [...base.slotPos], terrain: { ...base.terrain, slopeSigma: [...base.terrain.slopeSigma] }, bot: { ...base.bot } };
